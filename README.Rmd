...
The shiny server can be found on port `:3838` at your local machines ip (or localhost on windows), intro_to_tb_models can be found at `your-ip:3838/intro_to_tb_models`.
